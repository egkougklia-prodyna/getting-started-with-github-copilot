              ...
              .map(
                (participant) => `<li class="participant-item">
                  <span class="participant-main">
                    <span class="participant-avatar" aria-hidden="true">${escapeHtml(getEmailInitial(participant))}</span>
        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-section">
            <div class="participants-header">
              <h5>Participants</h5>
              <span class="participants-count">${participantCount} enrolled</span>
            </div>
            ${participantsList}
          </div>
        `;
